...
--
-- Hôte : localhost
-- Généré le : jeu. 26 oct. 2023 à 16:14
...
CREATE TABLE `PRODUITS` (
  ...
  `taille_figurine` double NOT NULL,
  `taille_vetement` varchar(3) NOT NULL,
  `couleur` text NOT NULL,
  `description` text NOT NULL,
  `dispo` double NOT NULL DEFAULT 0,
